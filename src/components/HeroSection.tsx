...
import { Sparkles, ShoppingBag, CheckCircle2, MessageCircle, HeartHandshake, ShieldCheck, Zap } from 'lucide-react';
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-16 md:py-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-5">
            <div className="relative bg-gradient-to-b from-stone-800 to-stone-900 p-6 rounded-3xl border border-amber-800/40 shadow-2xl space-y-5">
              
              <div className="relative h-60 rounded-2xl overflow-hidden shadow-md">
                <img
                  src={JAMU_IMAGE_ASSETS.heroShowcase}
                  alt="Kunyit Asam Warisan"
                  className="w-full h-full object-cover transform hover:scale-105 transition-transform duration-500"
                  referrerPolicy="no-referrer"
                />
                <div className="absolute top-3 right-3 bg-stone-950/80 backdrop-blur-md text-amber-300 px-3 py-1 rounded-full text-xs font-bold border border-amber-500/40">
                  Best Seller #1
                </div>
                <div className="absolute bottom-0 inset-x-0 bg-gradient-to-t from-stone-950 via-stone-950/60 to-transparent p-4">
                  <span className="text-amber-400 text-xs font-semibold uppercase tracking-wider">Favorit Nusantara</span>
                  <h3 className="text-white font-serif text-xl font-bold">Kunyit Asam Murni</h3>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-3 text-center">
                <div className="bg-stone-900/90 p-3 rounded-xl border border-stone-700/80">
                  ...
                  <span className="block text-[11px] text-stone-300 mt-0.5">Mulai Rp 14.000</span>
                </div>
                ...
                <div className="bg-stone-900/90 p-3 rounded-xl border border-amber-500/40 bg-amber-950/20">
                  ...
                  <span className="block text-[11px] text-amber-100 mt-0.5">Mulai Rp 25.000</span>
                </div>
              </div>

              <div className="p-3 bg-amber-500/10 rounded-xl border border-amber-500/20 text-xs text-amber-200/90 flex items-center gap-2.5">
                <HeartHandshake className="w-5 h-5 text-amber-400 flex-shrink-0" />
                <span>Pilihan ukuran dapat dipilih langsung pada setiap kartu produk katalog di bawah.</span>
              </div>
